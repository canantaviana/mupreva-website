...
var templateModules = {
    ...
    render_items: function (rows, term_id) {
        ...
        return elems.map(function(elem){
            var template = elem.template_name.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g,"").replaceAll(' ', '_');
    ...
    bloque_de_texto_con_imagen_a_la_derecha: function(info){
        return htmlTemplate(`
            <div class="block-text-img-dreta block-dedalo columns is-widescreen is-variable is-8">
                ...
                ${(info.title)?
                `<h2 class="is-flex is-align-items-center gap-2 mb-7 has-text-black">
    ...
    bloque_de_tres_columnas_desiguales: function(info, rows){
        ...
        console.log(children_container);
