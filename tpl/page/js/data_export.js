/**
* DATA EXPORT
* Parse catalog data to download then by web users as JSON / CSV
*/
...
page.export_parse_catalog_data = function (rows) {
    ...
    for (let i = rows.length - 1; i >= 0; i--) {
        ...
        delete row.measurements_data
        delete row.measure_type
        delete row.measure_value
        delete row.measure_unit
